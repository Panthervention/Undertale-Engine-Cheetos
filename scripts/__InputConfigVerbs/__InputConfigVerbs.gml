function __InputConfigVerbs()
{
	...
	if (not INPUT_ON_SWITCH)
	{
		...
		InputDefineVerb(INPUT_VERB.MENU,    "menu",       [vk_control, "C"],      gp_face3);
		InputDefineVerb(INPUT_VERB.UNUSED,  "unused",      undefined,             gp_face4);
	...
	else //Flip A/B over on Switch
	{
		...
		InputDefineVerb(INPUT_VERB.MENU,    "action",  undefined,   gp_face3);
		InputDefineVerb(INPUT_VERB.UNUSED,  "unused",  undefined,   gp_face4);
