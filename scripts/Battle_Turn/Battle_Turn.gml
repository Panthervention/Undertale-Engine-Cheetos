...
///@param {Real}	turn_info		The turn info to get the value (base on BATTLE_TURN enum or between 0 and 31).
...
///@param {Real}	turn_info		The turn info to set the value (base on BATTLE_TURN enum or between 0 and 31).
