...
var proc = 0; repeat (4)
{
    ...
    res_move_sprite[proc]=(sprite_exists(sprite_index) ? sprite_index : spr_fallback_default);
    res_move_image[proc] = 1;
    res_move_speed[proc] = 1/3;  
    res_move_flip_x[proc] = (proc == DIR.LEFT ? true : false);
    
    res_talk_sprite[proc] = (sprite_exists(sprite_index) ? sprite_index : spr_fallback_default);
